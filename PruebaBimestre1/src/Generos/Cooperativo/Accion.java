package Generos.Cooperativo;
import Generos.Videojuegos;//importamos para poder utilizar la clase Videojuegos

public class Accion extends Videojuegos {

    public Accion(String nombre, String siglas, int anio, String genero, String empresa){super(nombre, siglas, anio, genero, empresa);}
